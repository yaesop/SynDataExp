...
#######nano result #####
result_n = []
text_file = open("output_nano_"+position+"_"+"0"+".txt", "r")
...
for name in range(1,4):
    text_file = open("output_nano_"+position+"_"+str(name)+".txt", "r")
    lines = text_file.readlines()
    k = 0
    kk = 0
    for line in lines:
...
#######small result #####
result_s = []
text_file = open("output_small_"+position+"_"+"0"+".txt", "r")
lines = text_file.readlines()
k = 0
for line in lines:
    if k%2 ==1:
...
for name in range(1,4):
    text_file = open("output_small_"+position+"_"+str(name)+".txt", "r")
    lines = text_file.readlines()
    k = 0
    kk =0
    for line in lines:
...
#######medim result #####
result_m = []
text_file = open("output_medium_"+position+"_"+"0"+".txt", "r")
lines = text_file.readlines()
k = 0
for line in lines:
    if k%2 ==1:
...
for name in range(1,4):
    text_file = open("output_medium_"+position+"_"+str(name)+".txt", "r")
    lines = text_file.readlines()
    k = 0
    kk =0
    for line in lines:
...
#######large result #####
result_l = []
text_file = open("output_large_"+position+"_"+"0"+".txt", "r")
lines = text_file.readlines()
k = 0
...
for name in range(1,4):
    text_file = open("output_large_"+position+"_"+str(name)+".txt", "r")
    lines = text_file.readlines()
    k = 0
    kk =0
    for line in lines:
...
#######xlarge result #####
result_x = []
text_file = open("output_xlarge_"+position+"_"+"0"+".txt", "r")
lines = text_file.readlines()
k = 0
for line in lines:
    if k%2 ==1:
...
for name in range(1,4):
    text_file = open("output_xlarge_"+position+"_"+str(name)+".txt", "r")
    lines = text_file.readlines()
    k = 0
    kk = 0
    for line in lines:
...
result_n = np.reshape(result_n,(6,10))
result_s = np.reshape(result_s,(6,10))
result_m = np.reshape(result_m,(6,10))
result_l = np.reshape(result_l,(6,10))
result_x = np.reshape(result_x,(6,10))

print(result_n)
surface_n = ax1.plot_surface(xposM, yposM, result_n,  rstride=1, cstride=1,alpha=0.9, color='y', label = "yolov5-nano")
surface_s =ax1.plot_surface(xposM, yposM, result_s,  rstride=1, cstride=1,alpha=0.9 ,color='m', label = "yolov5-small")
surface_m =ax1.plot_surface(xposM, yposM, result_m,  rstride=1, cstride=1 ,alpha=0.4, color='green', label = "yolov5-medium")
surface_l =ax1.plot_surface(xposM, yposM, result_l, rstride=1, cstride=1 ,alpha=0.8, color='blue', label = "yolov5-large")
surface_x =ax1.plot_surface(xposM, yposM, result_x, rstride=1, cstride=1 ,alpha=0.7, color='red', label = "yolov5-xlarge")
...
print(sum(sum(result_n))/60)
print(sum(sum(result_s))/60)
print(sum(sum(result_m))/60)
print(sum(sum(result_l))/60)
print(sum(sum(result_x))/60)
#ax1.view_init(0, 0)
#ax1.set_box_aspect
